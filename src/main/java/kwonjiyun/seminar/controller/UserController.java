package kwonjiyun.seminar.controller;


import kwonjiyun.seminar.domain.User;
import kwonjiyun.seminar.dto.UserReq;
import kwonjiyun.seminar.dto.UserRes;
import kwonjiyun.seminar.dto.UsersRes;
import kwonjiyun.seminar.service.UserService;
...
public class UserController {
    ...
    @GetMapping("/users/{id}")
    public ResponseEntity<?> getUser(@PathVariable Long id){ //가져와서 읽어줄 수 있는 것이다.
